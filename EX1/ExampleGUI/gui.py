...
class MainGUI():
    ...
    def load_simulation(self, path, canvas, canvas_image):
    ...
    def start_gui(self, ):
        ...
        btn = Button(win, text='Load simulation', command=lambda: self.load_simulation('scenarios/test_scenario.json', canvas, canvas_image))
