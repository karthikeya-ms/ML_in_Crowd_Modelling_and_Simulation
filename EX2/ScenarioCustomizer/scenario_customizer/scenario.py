...
class Scenario:
    ...
    def __init__(self, path: str) -> None:
        ...
        self.assert_valid_scenario(path)
    ...
    def save(self):
        with open(self.scenario_path, 'w') as file:
    ...
    def add_pedestrian(self, x: float, y: float) -> None:
        max_id = 0
        ...
        # Update new pedestrian values
        pedestrian["attributes"]["id"] = new_ped_id
